package pacoteclasse_04_tela;

import javax.swing.DefaultListModel;

public class Classe_04_Tela extends javax.swing.JFrame {

    public Classe_04_Tela() {
        initComponents();
    }
    ...
    for (int i =1; i < 26; i++) {
    obj[i] = new Estoque();
    obj[i].setEstoque((char) ( i + 65), i, (i + 1) / 5.0f);
    }
    
    for (int i =1; i < 26; i++) {
    mod.addElement(obj[i].getEstoque());
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Classe_04_Tela().setVisible(true);
            }
        });
    }
